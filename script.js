document.addEventListener('DOMContentLoaded', () => {
    ...
    const romanticMessages = [
        "ইসসস...সুবর্ণা ভুল করে ক্লিক করলে নাকি? আরেকবার চেষ্টা করো প্লিজ! 🥰",
        "আমি জানি সুবর্ণা তুমি আমাকে ভালোবাসো, তাহলে 'না' বলছো কেন? 🥺",
        "আমার হৃদয় ভেঙে দিও না তো সুবর্ণা! 'হ্যাঁ' বলো না প্লিজ... 💖",
        "তুমি কি আমার সবটা নও সুবর্ণা? একবার ভেবে দেখো! 😔",
